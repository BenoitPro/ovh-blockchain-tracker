    ...
    return (
        <div className="min-h-screen relative overflow-hidden flex flex-col items-center bg-[#050510]">
            ...
            <div className="relative z-10 w-full flex flex-col items-center">
                ...
                <div className="w-full max-w-4xl px-6 pt-20 pb-12 flex flex-col items-center">
                    <motion.div 
                    ...
                    >
                        <h1 className="text-5xl md:text-6xl text-white font-black mb-6 bg-clip-text text-transparent drop-shadow-lg transition-all duration-1000 bg-gradient-to-r from-blue-300 via-blue-500 to-[#0153D4]">
                            The OVHcloud Web3 Team & Contact
                        </h1>
                ...
                >
                    <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                        <motion.a 
                            ...
                            className="font-bold text-lg px-8 py-4 rounded-xl flex items-center gap-3 bg-[#0153D4] text-white shadow-[0_0_40px_rgba(1,83,212,0.4)]"
                            animate={{ 
                                scale: [1, 1.03, 1],
                            }}
                            transition={{
                            ...
                            whileHover={{ 
                                ...
                                boxShadow: "0 0 60px rgba(1,83,212,0.7)",
                        ...
                        <motion.a 
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="glass-card font-bold text-lg px-8 py-4 !rounded-xl flex items-center gap-3 text-white"
                            animate={{ 
                                scale: [1, 1.03, 1],
                            }}
                            transition={{
                ...
                <div className="w-full max-w-4xl px-6 flex flex-col items-center">
                    ...
                    <motion.div 
                        ...
                        viewport={{ once: true }}
                        className="w-full rounded-3xl p-10 md:p-16 mb-20 relative overflow-hidden border transition-all duration-1000"
                        style={{
