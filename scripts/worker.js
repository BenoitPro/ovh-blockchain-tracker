...
import { filterOVHNodes, categorizeNodesByProvider } from '../src/lib/solana/filterOVH.js';
import { calculateMetrics } from '../src/lib/solana/calculateMetrics.js';
import { writeCache } from '../src/lib/cache/storage.js';
...
async function runWorker() {
    ...
    try {
        ...
        const allNodes = await fetchSolanaNodes(NODE_LIMIT);
        ...
        console.log(`   Performance: ${(allNodes.length / totalTime).toFixed(0)} nodes/second`);
        console.log('═'.repeat(60));
        console.log('');
